...
from backend import load_single_csv, load_zip_of_csvs, analyse, issues_to_dataframe
...
The app works with either a ZIP of multiple CSVs or a single CSV.
    """)
...
uploaded = st.file_uploader(
    ...
    type=["csv", "zip"],
    help="Upload a single CSV or a ZIP of multiple CSVs from Screaming Frog",
)
